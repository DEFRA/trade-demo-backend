using TradeDemoBackend.Example.Endpoints;
using TradeDemoBackend.Example.Services;
using TradeDemoBackend.Utils;
using TradeDemoBackend.Utils.Http;
using TradeDemoBackend.Utils.Mongo;
using FluentValidation;
using System.Diagnostics.CodeAnalysis;
using TradeDemoBackend.Config;
using TradeDemoBackend.Utils.Logging;
using Serilog;
